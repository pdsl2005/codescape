...
const settings = [
  {
    ...
    description:
      "Keep new cities visible only to teammates you approve.",
  },
  {
    icon: Bell,
    title: "Notifications",
  ...
  const accountItems = [
    {
      ...
      description: isSignedIn
        ...
        : "Connect to import repos",
      status: isSignedIn ? "Connected" : "Not connected",
      statusAccent: isSignedIn
    ...
    },
    {
      ...
      statusAccent: "bg-[#EFF6FF] text-[#2563EB]",
    },
  ];
            ...
            <div className="rounded-[2rem] border border-white/60 bg-white/50 p-8 shadow-[0_28px_60px_-30px_rgba(59,130,246,0.24)] backdrop-blur-[12px]">
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-[#4B5563]">
                {isSignedIn
                  ...
                  : "Sign in with GitHub to start importing your repositories and visualizing them as cities."}
              </p>
              {!isSignedIn && (
                <div className="mt-6">
                  <SignInButton
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {settings.map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="rounded-[2rem] border border-white/60 bg-white/50 p-6 shadow-[0_24px_60px_-30px_rgba(59,130,246,0.18)] backdrop-blur-[12px]"
                  >
          ...
          <aside className="space-y-6">
            <div className="rounded-[2rem] border border-white/60 bg-white/50 p-6 shadow-[0_24px_60px_-30px_rgba(59,130,246,0.18)] backdrop-blur-[12px]">
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#4B5563]">
                    Connected accounts
                  </p>
                  <p className="mt-1 text-xs uppercase tracking-[0.32em] text-[#3B82F6]">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span
                          className={`whitespace-nowrap rounded-full px-3 py-1 text-xs font-semibold ${item.statusAccent}`}
                        >
                          {item.status}
                        </span>
                      </div>
              ...
              {isSignedIn && (
                <div className="mt-4">
                  <SignOutButton className="w-full rounded-xl border border-[var(--border)] bg-white px-4 py-3 text-sm font-semibold text-[#4B5563] transition hover:bg-[#F3F4F6]">
                    Sign out
                  </SignOutButton>
                </div>
              )}
            ...
            <div className="rounded-[2rem] border border-white/60 bg-white/50 p-6 shadow-[0_24px_60px_-30px_rgba(59,130,246,0.18)] backdrop-blur-[12px]">
              ...
              <p className="mt-3 text-sm leading-7 text-[#4B5563]">
                Keep your architectural world secure and streamlined with
                one-click controls.
              </p>
